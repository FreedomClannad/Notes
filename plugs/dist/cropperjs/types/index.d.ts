...
declare class Cropper {
  constructor(element: HTMLElement, options?: Cropper.Options<HTMLImageElement>);
  constructor(element: HTMLImageElement, options?: Cropper.Options<HTMLCanvasElement>);
  constructor(element: HTMLCanvasElement, options?: Cropper.Options<HTMLCanvasElement>);
  clear(): Cropper;
  editCrop(props: {left: number, top: number, width: number, height: number }): Cropper;
  crop(): Cropper;
  destroy(): Cropper;
  disable(): Cropper;
  enable(): Cropper;
